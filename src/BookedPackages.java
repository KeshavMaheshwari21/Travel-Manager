...
public class BookedPackages extends JFrame implements ActionListener {
    ...
    BookedPackages() {
        ...
        String[] columnNames = { "Username",  "Package", "Id", "Number", "Phone", "Price" };
    ...
    public void fetchData() {
        try {
            ...
            while (rs.next()) {
                ...
                String packages = rs.getString("package");
                ...
                model.addRow(new Object[] { username, packages, persons, id, number, phone, price });
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
