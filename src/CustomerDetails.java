...
public class CustomerDetails extends JFrame implements ActionListener {
    ...
    CustomerDetails() {
        ...
        JLabel lblusername = new JLabel("Enter Username to DELETE Details :");
        ...
        String[] columnNames = { "Username", "Id", "Number", "Name", "Gender", "Country", "Address", "Phone", "Email" };
    ...
    public void fetchData() {
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[] { username, id, number, name, gender, country, address, phone, email });
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
